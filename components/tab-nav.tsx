          ...
          {tabs.map(tab => {
            ...
            return (
              <Link key={tab.href} href={tab.href}
                ...
                style={active
                  ? { background: tab.color, color: '#fff', borderColor: 'rgba(255,255,255,0.2)', boxShadow: `4px 4px 0px 0px ${tab.color}40` }
                  : { color: tab.color, borderColor: 'transparent', background: 'transparent' }
                }
              >
                <Icon className="h-3.5 w-3.5 flex-shrink-0 transition-all duration-300"
