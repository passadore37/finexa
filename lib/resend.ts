...
// Trocar para noreply@finexa.app quando verificar o domínio no Resend
  ...
  return resend.emails.send({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:520px;margin:0 auto;padding:32px 24px;background:#0f0f0f;color:#f5f5f5;border-radius:16px">
        <div style="width:48px;height:48px;background:#5330ff;border-radius:12px;font-size:24px;font-weight:900;color:#fff;display:flex;align-items:center;justify-content:center;margin-bottom:24px">F</div>
  ...
  return resend.emails.send({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:520px;margin:0 auto;padding:32px 24px;background:#0f0f0f;color:#f5f5f5;border-radius:16px">
        ...
        <p style="color:#888;margin:0 0 24px;line-height:1.6"><strong style="color:#f5f5f5">${nomeQuemConvidou}</strong> te convidou para o Finexa. Clique abaixo para entrar.</p>
  ...
  return resend.emails.send({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:520px;margin:0 auto;padding:32px 24px;background:#0f0f0f;color:#f5f5f5;border-radius:16px">
        ...
        ${dados.diasAtivos === 0 ? `
          <div style="background:#2a1a1a;border:1px solid #E24B4A33;border-radius:12px;padding:16px;margin-bottom:24px">
            <p style="margin:0;font-size:13px;color:#E24B4A">Você não lançou nada essa semana 😅 — leva só 30 segundos! Que tal começar agora?</p>
          </div>
        ` : dados.diasAtivos >= 5 ? `
          <div style="background:#1a2a1a;border:1px solid #01b69533;border-radius:12px;padding:16px;margin-bottom:24px">
            <p style="margin:0;font-size:13px;color:#01b695">🔥 Incrível! Você ficou ativa ${dados.diasAtivos} dias essa semana. Continue assim!</p>
          </div>
        ` : `
          <div style="background:#1a1a2a;border:1px solid #5330ff33;border-radius:12px;padding:16px;margin-bottom:24px">
            <p style="margin:0;font-size:13px;color:#82a1fd">💪 Boa semana! Tente registrar pelo menos 1 gasto por dia para ter uma visão mais precisa.</p>
          </div>
        `}

        <a href="${process.env.NEXT_PUBLIC_APP_URL}/dashboard" style="display:inline-block;background:#5330ff;color:#fff;padding:14px 28px;border-radius:12px;text-decoration:none;font-weight:900;font-size:14px">
          Abrir Finexa →
        </a>
